...
const HOTEL_CELLS := [8, 14, 20, 29, 43]
const REWARD_COINS := 100
const WHEEL_RESULTS := [50, 100, 200, 500, -50, -100]
const WHEEL_SPIN_DURATION := 3.0
const WHEEL_FULL_SPINS := 6.0

# The complete 50-cell map layout lives here so board design changes stay data-only.
const MAP_CELL_TYPES := [
	CELL_START,                                                     # 0
	CELL_PROPERTY, CELL_PROPERTY, CELL_PROPERTY, CELL_QUIZ,        # 1-4
	CELL_ENCOUNTER, CELL_QUIZ, CELL_PROPERTY, CELL_PROPERTY,       # 5-8
	CELL_WHEEL, CELL_PROPERTY, CELL_QUIZ, CELL_PROPERTY,           # 9-12
	CELL_ENCOUNTER, CELL_PROPERTY, CELL_SHOP, CELL_QUIZ,           # 13-16
	CELL_PROPERTY, CELL_QUIZ, CELL_PROPERTY, CELL_PROPERTY,        # 17-20
	CELL_ENCOUNTER, CELL_WHEEL, CELL_QUIZ, CELL_PROPERTY,          # 21-24
	CELL_QUIZ, CELL_PROPERTY, CELL_QUIZ, CELL_SHOP,                # 25-28
	CELL_PROPERTY, CELL_QUIZ, CELL_ENCOUNTER, CELL_PROPERTY,       # 29-32
	CELL_QUIZ, CELL_PROPERTY, CELL_QUIZ, CELL_PROPERTY,            # 33-36
	CELL_PROPERTY, CELL_QUIZ, CELL_PROPERTY, CELL_PROPERTY,        # 37-40
	CELL_ENCOUNTER, CELL_QUIZ, CELL_PROPERTY, CELL_PROPERTY,       # 41-44
	CELL_QUIZ, CELL_PROPERTY, CELL_QUIZ, CELL_PROPERTY,            # 45-48
	CELL_PROPERTY,                                                 # 49
]
